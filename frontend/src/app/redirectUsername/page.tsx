  ...
  return (
    <div className="h-screen flex justify-center items-center bg-black">
      <main className="flex flex-col ">
        <h1 className=" flex items-center justify-center font-extrabold text-6xl text-mustard ">
          {" "}
          Form Page
        </h1>
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    <FormLabel className="flex justify-center text-white text-3xl font-bold">
                      {" "}
                      User name
                    </FormLabel>
                    <FormControl>
            ...
            />
            <Button typeof="submit" className="w-full bg-darkest-purple">
              {" "}
              Submit{" "}
            </Button>
          </form>
